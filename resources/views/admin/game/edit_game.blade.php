            ...
            <form action="{{URL('update-games/'.$key->id)}}" method="post" enctype="multipart/form-data">
                ...
                <table class="form">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="game_name" value="{{$key->name}}" placeholder="Nhập tên Danh mục Moi..." class="medium" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="game_title" value="{{$key->title}}" placeholder="Nhập tên Danh mục Moi..." class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="game_desc" value="{{$key->desc}}" placeholder="Nhập desc Moi..." class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="game_image" value="{{$key->image}}" placeholder="Nhập tên images Moi..." class="medium"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="game_link" value="{{$key->link}}" placeholder="Nhập tên images Moi..." class="medium"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
